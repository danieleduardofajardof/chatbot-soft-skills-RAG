...
def generate_response_with_context(user_id: str, user_input: str) -> str:
    """
    Generate a chatbot response using Azure OpenAI GPT-3.5 with multi-turn conversation support.
    ...
    try:
        ...
        update_user_session(user_id, user_input, bot_response)
...
def update_user_session(user_id: str, user_message: str, bot_response: str) -> None:
    ...
    try:
        ...
        # Limit the conversation to the last 5 turns
    ...
    if 'event' in data:
        ...
        if event.get('type') == 'message' and 'subtype' not in event:
            ...
            if user_input and user_id and channel and user_id != bot_user_id:
                ...
                bot_response = generate_response_with_context(user_id, user_input)
        ...
        # Handle file share events
            ...
            if user_id == bot_user_id:
                ...
                try:
                    ...
                    if transcribed_text:
                        bot_response = generate_response_with_context(user_id, transcribed_text)
